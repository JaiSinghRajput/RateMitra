...
const QRCodePoster = forwardRef<HTMLDivElement, QRCodePosterProps>(({
  ...
  return (
    <div
      ref={ref}
      className="w-198.5 h-280.75 relative overflow-hidden font-sans flex flex-col items-center justify-center bg-linear-to-br from-white via-slate-50 to-white"
    >
      ...
      <div className="z-10 flex flex-col items-center justify-center w-full px-16 h-full text-center">
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-6xl font-black tracking-tight leading-tight mb-4 drop-shadow-sm" style={{ color: textColor }}>
            {storeName || "Our Store"}
          </h1>
          <p className="text-2xl font-medium tracking-wide uppercase text-gray-600">
            Official Price List
          </p>
        </div>

        <div className="relative p-12 rounded-[3rem] shadow-2xl flex items-center justify-center transform transition-transform hover:scale-105 bg-white border-4 border-gray-50">
          <QRCode
            value={storeUrl}
            size={350}
        ...
        <div className="mt-16">
          ...
          <p className="text-xl font-medium text-gray-500 flex items-center justify-center gap-2">
